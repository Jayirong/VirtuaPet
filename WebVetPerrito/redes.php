                ...
                <div class="row text-center">
                    <div class="col-md-4">
                        <span class="fa-stack fa-7x">
                            <a href="https://twitter.com/vetperrito"><img class="img-fluid" src="assets/img/logos/twitter.png" alt="..." /></a>
                        </span>
                        <h4 class="my-3">Cuenta de Twitter</h4>
                        <p class="text-muted"></p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-7x">
                            <a href="https://www.facebook.com/profile.php?id=100081358071030"><img class="img-fluid" src="assets/img/logos/facebook.png" alt="..." /></a>
                        </span>
                        <h4 class="my-3">Pagina de Facebook</h4>
                        <p class="text-muted"></p>
                    </div>
                    <div class="col-md-4">
                        <span class="fa-stack fa-7x">
                            <a href="http://www.instagram.com"><img class="img-fluid" src="assets/img/logos/instagram.jpg" alt="..." /></a>
                        </span>
                        <h4 class="my-3">Cuenta de Instagram</h4>
                        <p class="text-muted"></p>
                    </div>
                </div>
            </div>
